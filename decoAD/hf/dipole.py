...
def dipole3(E, decomp, mol):
    ...
    ao_dip = mol.intor_symmetric('int1e_r', comp=3)
    h1 = mf.get_hcore()
    el_dip = -jacrev(jacrev(hf_e))(E, decomp, mf, ao_dip, h1)
    nuc_dip = -jacrev(nucl_dip)(E, decomp, mf, ao_dip, h1)
    # print('Electric Polarizability')
    # print(el_dip)
    # print('Nuclear Polarizability')
    # print(nuc_dip)
